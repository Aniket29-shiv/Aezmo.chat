package com.aniket.aezmodate.utils;
...
public class MessageUtil {
    ...
    public static void addMessageBean(RtmMessage msg, String userId, String peerId) {
        MessageBean messageBean = new MessageBean(msg.getText(), userId, peerId);

        System.out.println("RTMessage "+ messageBean);

        int ret = existMessageListBean(userId);
        if (ret == -1) {
